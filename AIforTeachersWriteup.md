...
โปรเจกต์นี้ผมได้รับผ่าน[หยก](https://www.facebook.com/papatsiri.apipaiboon) และก็ได้รับมาผ่าน[ช้าง](https://www.facebook.com/phantipk)อีกที หลังจากที่ทางทีมนั้นได้ลอง LMS ต่างๆ แต่ก็เหมือนจะไม่มีตัวที่โอเคพอในด้าน customization และราคา เลยได้ข้อสรุปกันว่า custom development น่าจะเวิร์คสุด หยกช่วยประสานงานกับทางทีม ส่วนช้างช่วยดูเรื่องการเตรียม infra เช่นโดเมนเนมกับ Azure resource ต่างๆ

โดยโปรเจคนี้เหมือนเป็น lightweight LMS โดย flow หลักคือ:

1. ลงทะเบียน กรอกข้อมูลที่จะเอาไว้ใช้ในการออกเกียรติบัตรและวุฒิบัตร
2. กดลงทะเบียนเรียนตามเวลาที่สะดวก
3. ถึงเวลาก็เข้าเรียน (ดูผ่าน YouTube Live) โดยมีระบบลงชื่อเข้าเรียนและบันทึกเวลาเรียน มีคลังเอกสาร (ก็คือลิงก์ไปไฟล์ PDF)
4. เรียนเสร็จครบโมดูลก็ทำข้อสอบ
5. ถ้าสอบผ่านก็จะได้เกียรติบัตร
6. ถ้าเงื่อนไขครบถ้วนก็จะได้วุฒิบัตรด้วย
...
[ผมเคยโดน Firebase ส่งเมลมาเก็บเงินกลางดึกเพราะลืมใส่ dependency array ใน `useEffect`](https://x.com/dtinth/status/1225802585539371008) ทำให้เกิดการเรียก API ไปที่ Firebase ตลอดเวลา จนค่าใช้จ่ายพุ่งไปสิบๆ เหรียญในไม่กี่ชั่วโมง
...
- ระบบที่ออกแบบมา คือให้การเข้าเรียน การสอบ และการออกเกียรติบัตร/วุฒิบัตร แยกกันอย่างสิ้นเชิง เพื่อความยืดหยุ่น — แปลว่าต้องมี background job ที่คอยมาทำงานพวกนี้ คือ
  ...
  ซึ่งทีแรกก็คิดว่า implement เป็น SQL ดีไหม แต่สุดท้ายก็เขียนเป็น TypeScript แล้วเอามารันบน VPS แทน
