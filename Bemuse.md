...
::cta[Play the game]{href="https://bemuse.ninja"}
...
::cta[Source code on GitHub]{href="https://github.com/bemusic/bemuse"}
...
:::figure{.framed}
![](https://dt.in.th/uploads/bemuse-google-analytics-2019.png)
:::
...
- Tutorial song: [BY☆MY☆SIDE](ByMySide)
- Music selection song: [BY☆MY☆SIDE (Ambient House Mix)](ByMySideAmbientHouseMix)
- Delay calibration song: [AUTO±SYNCHRO](AutoSynchro)
