...
# CSS Spring Animation Using Physics and Calculus
...
In this [talk](Talks) and [project](Projects), I implemented a realistic spring-type animation using basic knowledge of physics and calculus. I talk about this because many software engineering students wonder if they'll ever use the knowledge learn from the required Calculus and Physics course in their life. I want to show that knowledge allows you to be more creative.

Presented at [BarCamp Bangkhen 6](http://2015.barcampbangkhen.org/).

</div>

::cta[Writeup]{href="https://medium.com/@dtinth/spring-animation-in-css-2039de6e1a03"}
::cta[Demo]{href="https://codepen.io/dtinth/pen/jbXKRv"}