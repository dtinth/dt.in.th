---
title: Using macOS's dashes and smart quotes shortcuts in Windows
public: true
facebook: https://web.facebook.com/dtinth/posts/10216038733875332
twitter: https://twitter.com/dtinth/status/1345807452873261056
aliases:
  - 20210103T184413Z4586
---

**Having recently started using [Windows](Windows),** I missed the typographic hotkeys in [Macs](MacOS), such as [em-and-en-dashes](https://twitter.com/swyx/status/1344127570753646593), [curly quotes](https://practicaltypography.com/straight-and-curly-quotes.html)[^nosmart], and [ellipsis](https://practicaltypography.com/ellipses.html). Thankfully [AutoHotKey](https://www.autohotkey.com/) exists, and here is a script that remaps the keys to what I am used to type on a Mac.
...
<div class="post-key-table">

| Key                             | Result |
| ------------------------------- | ------ |
| <span v-html="winkey"></span>[  | “      |
| <span v-html="winkey"></span>⇧[ | ”      |
| <span v-html="winkey"></span>]  | ‘      |
| <span v-html="winkey"></span>⇧] | ’      |
| <span v-html="winkey"></span>-  | –      |
...
[^nosmart]: I don’t have smart quotes turned on; I always manually type out curly quotes. Except when using Microsoft Word.
