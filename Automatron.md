...
![Photo of my phone with chat logs](https://im.dt.in.th/ipfs/bafybeihomh4ucklqgs4lqw2yclbokvhs5uv3eram7buayzeh5dphnipkee/automatron.jpg)
...
::cta[GitHub repository]{href="https://github.com/dtinth/automatron"}
...
![Airtable table showing scheduled commands](https://im.dt.in.th/ipfs/bafybeieil4qk7lfqpzkd7whtwg6td7gi6unkywookqzcujfnvjl6mzlmr4/automatron-schedule.jpg)
...
- As a result, I [migrated](https://github.com/dtinth/automatron/pull/6) the bot to [**Google Cloud Run**](https://cloud.google.com/run).
  ...
  ![Google Cloud Billing](https://im.dt.in.th/ipfs/bafybeifkxyfpvt5h4gtnt4je3wwr7pp6fmoa2f3tvmqejeou2dkliapwju/automatron-gae-to-cloud-run.webp)
...
- In 2022, I gave a presentation about automatron at Dev Mountain Tech Festival in a talk titled _[“Let’s build a personal assistant and level-up your coding skills!”](PersonalAssistantTalk)_
